	...
	NumberOfSubgroups = 1;
 	...
 	Begin["Private`"];
		...
		BetaQuartic[a_, b_, c_, d_, la_, lb_, lc_, ld_, 0] := Module[
			{pa, pb, pc, pd, q},
			Return[
				ReleaseHold[(SymQuartic[a,b,c,d]/.subQuart)]//.{
