...
YukawaYaij[Yd, H2, adj[Q], D, {1 &, KroneckerDelta[#1, #2] &, KroneckerDelta[#2, #3] &}];
YukawaYaij[Ye, H2, adj[L], E, {1 &, KroneckerDelta[#1, #2] &, 1 &}];
YukawaYaij[Yu, H1, adj[Q], U, {1 &, KroneckerDelta[#1, #2] &, KroneckerDelta[#2, #3] &}];
